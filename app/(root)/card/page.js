...
const Page = () => {
  ...
  const {
    ...
    `https://bookappserver-1749.onrender.com/api/getBook?UserID=-1&Status=${selectedStatus}&Genres=${selectedGenre}`,
    fetcher
  );
        ...
        {status == "authenticated" ? (
          ...
          <>
            <div className="w-full flex justify-center">
              <p className="bg-gray-500 p-5 rounded-lg text-white">
                Please login to access the books
              </p>
            </div>
          </>
        )}
